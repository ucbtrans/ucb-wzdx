          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1 className="text-4xl font-bold text-orange-500 tracking-tight sm:text-5xl md:text-6xl">
                ZoneMapper
                <span className="block text-orange-800 text-5xl">A Work Zone Mapping Tool</span>
              </h1>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-lg text-gray-500">
                ...
                and running quickly. Dont waste time on boilerplate - focus on
